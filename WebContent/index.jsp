...
<html lang="es">
  ...
  <body>
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			<h1 class="logo"><a href="index.html#home">School Help</a></h1>
			<i class="fa fa-arrow-right menu-close"></i>
			<a href="index.html">Inicio</a>
			<a href="services.html">Biblioteca</a>
			<a href="portfolio.html">Mi cuenta</a>
			<a href="about.html">Ser asesor</a>
			<a href="#contact">Buscar asesor</a>
    ...
    <div class="container">
      <div class="row mt">
      	<div class="col-lg-8">
	        <h1>Te ayudamos con tus dudas y proyectos </h1>
	        <p>School Help es una comunidad donde podras preguntar y ayudar a las demas personas con sus dudas academicas. Si estas atascado en algo solo pregunta y en menos de lo que esperas un asesor te dara ayuda personalizada a tu problema completamente gratis.<br>
	          Tambien puedes	buscar en nuestro historial de ayuda si ya se le dio asesoria a alguien en un tema relacionado</p>
      	</div>
      	<div class="col-lg-4">
      		<p class="pull-right"><br><button type="button" class="btn btn-green">Encuentra un asesor  </button>
           <br> <br><button type="button" class="btn btn-default">Convertirse en asesor</button></p>
      	</div>
        <div class="col-lg-8">
	        <hr>
	        <h1>Todas las categorias</h1>
          <p>A continuacion te presentamos las categorias donde tenemos asesores activos.</p>
      	</div>
      </div><!-- /row -->
    </div><!-- /.container -->
    	...
    	<div class="container">
	    	<div class="row mt">
				<ul class="grid effect-2" id="grid">
					...
					<li><a href="windows.html"><img src="assets/img/categories/windows.jpg"></a></li>
			
			
					<li><a href="linux.html"><img src="assets/img/categories/linux.jpg"></a></li>
					<li><a href="singleproject.html"><img src="assets/img/categories/java.jpg"></a></li>
					<li><a href="singleproject.html"><img src="assets/img/categories/android.jpg"></a></li>
					<li><a href="singleproject.html"><img src="assets/img/portfolio/2.jpg"></a></li>
					<li><a href="singleproject.html"><img src="assets/img/categories/apple.jpg"></a></li>
