...
<html>
    ...
    <body>
        <f:view>
            ...
            <h:form id="formularioLogin" role="form">
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td><h:inputText value="#{loginBean.user}" styleClass="form-control"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <h:inputText value="#{loginBean.fecha1}" styleClass="form-control">
                    ...
                    <tr>
                        ...
                        <td>
                            <h:inputText value="#{loginBean.fecha2}" styleClass="form-control">
                                <f:convertDateTime type="date" dateStyle="short"/>
                            </h:inputText>
                        </td>
                    </tr>
